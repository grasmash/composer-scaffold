...
class Plugin implements PluginInterface, EventSubscriberInterface, Capable {
  ...
  public static function scaffold(Event $event) {
    @trigger_error('\Grasmash\ComposerScaffold\Plugin::scaffold is deprecated since version 2.5.0 and will be removed in 3.0. Use "composer drupal:scaffold" instead.', E_USER_DEPRECATED);
